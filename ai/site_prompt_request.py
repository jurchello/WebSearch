...
class SitePromptRequest(BaseRequest):
    """
    ...
    Attributes:
        data (AIDomainData): The domain data used to generate the prompt.
        prompt_builder (SitePromptBuilder): A builder used to create the prompt for the AI.
    """

    def __init__(self, data: AIDomainData, prompt_builder: SitePromptBuilder):
